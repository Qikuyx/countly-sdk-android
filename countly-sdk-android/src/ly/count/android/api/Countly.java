...
public class Countly {
    ...
    public void init(Context context, String serverURL, String appKey) {
        init(context, serverURL, appKey, null, null, null);
    }

    /**
     * Make it compatible with old init method
     * 
     * @param context
     * @param serverURL
     * @param appKey
     ...
     * @param channel
     * 
     * @author wangqi 2014-05-20 
     */
    public void init(Context context, String serverURL, String appKey, 
    		String region, String server, String channel) {
        ...
        /**
         * Check first if the additional fields are set.
         * wangqi 2014-05-20
         */
        if ( region != null ) {
